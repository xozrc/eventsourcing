...
// Source: github.com/xozrc/eventsourcing/event (interfaces: EventSourced)

package mock_event

import (
	gomock "github.com/golang/mock/gomock"
	event "github.com/xozrc/eventsourcing/event"
	types "github.com/xozrc/eventsourcing/types"
)
...
func (_m *MockEventSourced) ApplyEvent(_param0 event.VersionedEvent) error {
...
func (_m *MockEventSourced) Events() []event.VersionedEvent {
	ret := _m.ctrl.Call(_m, "Events")
	ret0, _ := ret[0].([]event.VersionedEvent)
	return ret0
}
...
func (_m *MockEventSourced) SourceId() types.Guid {
	ret := _m.ctrl.Call(_m, "SourceId")
	ret0, _ := ret[0].(types.Guid)
	return ret0
}

func (_mr *_MockEventSourcedRecorder) SourceId() *gomock.Call {
